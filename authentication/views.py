...
class SignupView(generics.GenericAPIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            <p>Welcome to the Family. We're happy you signed up for Enerdit.</p>
            ...
            data={'email_body': email_body, 'to_email': user.email, 'email_subject':'Welcome to Enerdit', 'email_html': email_html}
    ...
    def get(self, request):
        ...
        try:
            ...
            if user and not user.is_verified:
                user.delete()
            return Response({'error': 'Activation link expired, user deleted'}, status=status.HTTP_400_BAD_REQUEST)
